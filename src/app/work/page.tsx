  ...
  return (
    <Container className="mt-40">
      {/* <FadeIn>
        ...
        Pravne usluge koje štite vaša prava i interese
        </h2>
      </FadeIn> */}
...
export default async function Work() {
  ...
  return (
    <>
      ...
      >
        <p>
        Naš tim iskusnih advokata pruža stručne pravne savete i zastupanje u širokom spektru pravnih oblasti, osiguravajući da vaša prava budu zaštićena i da svaki pravni korak bude u skladu sa zakonima.
        </p>
      </PageIntro>
